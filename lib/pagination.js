...
var _pager = __webpack_require__(148);
    ...
    First: {
      render: function render(h) {
        return h(
          ...
          [this.$parent.firstText ? h('span', [this.$parent.firstText]) : h(
            'span',
            { 'class': 'arrow-wrap' },
            [h('i', { 'class': 'el-icon el-icon-d-arrow-left' })]
          )]
        );
      }
    },
    ...
    Prev: {
      render: function render(h) {
        return h(
          ...
          [this.$parent.prevText ? h('span', [this.$parent.prevText]) : h(
            'span',
            { 'class': 'arrow-wrap' },
    ...
    Next: {
      render: function render(h) {
        return h(
          ...
          [this.$parent.nextText ? h('span', [this.$parent.nextText]) : h(
            'span',
            { 'class': 'arrow-wrap' },
    ...
    Last: {
      render: function render(h) {
        return h(
          ...
          [this.$parent.lastText ? h('span', [this.$parent.nextText]) : h(
            'span',
            { 'class': 'arrow-wrap' },
            [h('i', { 'class': 'el-icon el-icon-d-arrow-right' })]
          )]
        );
      }
    },
    ...
    TotalPage: {
      ...
      render: function render(h) {
        return typeof this.$parent.total === 'number' ? h(
          ...
          [this.t('el.pagination.totalPageXc', { cur: this.$parent.internalCurrentPage, total: Math.ceil(this.$parent.total / this.$parent.pageSize) })]
        ) : ''
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_89c6eabc_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pager_vue__ = __webpack_require__(149);
