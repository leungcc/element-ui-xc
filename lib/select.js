...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_select_vue__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_48d4dd30_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_select_vue__ = __webpack_require__(215);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_48d4dd30_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_select_vue__["a" /* default */],
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_select_dropdown_vue__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7cc65dcd_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_select_dropdown_vue__ = __webpack_require__(213);
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44352158_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_option_vue__ = __webpack_require__(46);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44352158_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_option_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var _selectDropdown = __webpack_require__(212);
...
var _navigationMixin = __webpack_require__(214);
...
String.prototype.strlen = function () {
  ...
  str += '';
  if (!str) {
    console.error('string call strlen size must > 0');
    return;
  }
  //开始计算
  var len = 0;
...
/**
 * @desc 计算tag的宽度
 * @param {Number} str 多少个字
 * @return {Number} 宽度
 */
var calcTagWidth = function calcTagWidth(str) {
  var fontW__en = 6;
  var len = str.strlen();
...
exports.default = {
  ...
  computed: {
    ...
    // 不想显示select
    selectedShow: function selectedShow() {
      var self = this;
      var currentLabelsWidth = 0;
      return self.selected.reduce(function (result, cur) {
        if (currentLabelsWidth + calcTagWidth(cur.currentLabel) < self.inputWidth - 40) {
          currentLabelsWidth += calcTagWidth(cur.currentLabel);
          result.push(cur);
        }
        return result;
      }, []);
  ...
  methods: {
    ...
    getOption: function getOption(value) {
      ...
      //   ? value : '';
      var label = this.noOptionMatchNull ? '' : !isObject && !isNull ? value : '';
      var newOption = {
        value: value,
        currentLabel: label
      };
